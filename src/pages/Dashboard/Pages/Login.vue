          ...
          <form ref="login_form" @submit.prevent="handleSubmit(submit)">
            <div class="md-layout create-field-group mt-3">
              ...
              <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
                <md-button type="submit" class="md-info w-100">
                  <strong><h6 class="mt-2 mb-2">Log in</h6></strong>
                </md-button>
              </div>
              <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
                <md-button class="md-danger w-100" @click="forgotPass">
                  <strong><h6 class="mt-2 mb-2">Forgot password</h6></strong>
                </md-button>
              </div>
            </div>
          </form>
